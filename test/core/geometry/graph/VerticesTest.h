...
#ifndef SRC_APPS_TEST_CORE_GEOMETRY_GRAPH_VERTICESTEST_H_
#define SRC_APPS_TEST_CORE_GEOMETRY_GRAPH_VERTICESTEST_H_
...
#endif /* SRC_APPS_TEST_CORE_GEOMETRY_GRAPH_VERTICESTEST_H_ */
