...
PML alpha factor: *GenData(PML_alpha_factor)
PML alpha order: *GenData(PML_alpha_order)
PML kappa: *GenData(PML_kappa)
PML correction factor: *GenData(PML_correction_factor)
PML correction depth: *GenData(PML_correction_depth)
